...
(*|
TIPS: A few things that might be helpful keep in mind as you work on Pset 12
============================================================================
...
Our with-locks lemma looks like this:
...
Our proof of deadlock_freedom' begins by calling `excluded_middle (exists a, a \in locksOf p)`.
|*)
