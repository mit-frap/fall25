(** * 6.512 Formal Reasoning About Programs, Fall 2025 - Pset 11 *)
...
(* The Forgetful Loop Rule
 ...
 Pset11Sig.v; we recommend that you read through it now.  Most of the contents
...
Proof.
  ...
  -
    ...
    + rewrite llist_nonnull by assumption.
      ...
      (* We specify the hypothesis [n] of [llist_nonnull] so that Rocq chooses to
       * rewrite the correct occurrence of [llist] in the goal.  Try without that
       * detail and watch Rocq make the wrong choice! *)
      cancel.
  - cancel.
  - cancel.
Qed.
